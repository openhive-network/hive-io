...
const milestones: Milestone[] = [
  ...
  },
  {
    ...
    description: 'Simplifies and standardizes API and dApp development for Hive, improves efficiency and scalability, promotes modular design.',
    status: 'completed',
    features: [
      'Hive Application Framework (HAF) for building Hive APIs and dApps',
      'HAF are defined in PostgreSQL and can be deployed easily',
    ],
  },
  {
    type: 'hardfork',
