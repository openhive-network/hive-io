              ...
              if (item.children && item.children.length > 0) {
                return (
                  <NavigationMenuItem key={index}>
                    <NavigationMenuTrigger className="text-base font-normal bg-transparent border-none py-[5px] px-2.5 cursor-pointer transition-colors duration-100 ease-in hover:text-[#e31337] data-[state=open]:text-[#e31337]">
                      {item.name}
                    </NavigationMenuTrigger>
                    <NavigationMenuContent className="p-3 min-w-[280px]">
