export default {
  ...
  hbd: {
    ...
    text: 'HBD is a native stablecoin on the Hive blockchain. HBD is built to hold $1USD value in the most decentralized ways. It benefits from the fee-less and fast transactions of the Hive blockchain.',
    howTitle: 'How does it maintain the $1USD peg?',
    howText: 'There are two decentralized conversion operations designed to achieve this goal. HIVE to HBD conversion and HBD to HIVE conversion. These two operations keep the price at $1USD with a tight margin.',
    hbdToHiveTitle: 'HBD to HIVE conversion',
    hbdToHiveText: 'This operation converts set amounts of HBD to $1USD worth of HIVE with no extra fees. It takes 3.5 days for the conversion to finalize. The price in this conversion is the median price of the coming 3.5 days to prevent market manipulations.',
    ...
    interestText: 'Placing your HBD savings in a Savings Account on Hive will generate returns. Saving is an action that locks the HBD with a unlock time of only 3 days. The interest rate is voted by the witnesses and is variable. It is currently at 20% APR.',
